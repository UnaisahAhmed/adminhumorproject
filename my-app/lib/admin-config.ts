...
export const adminTableConfigs = {
  profiles: {
    ...
    displayColumns: [
      ...
      { name: "is_superadmin", label: "Superadmin" },
      { name: "is_in_study", label: "In Study" },
  ...
  "humor-flavor-steps": {
    ...
    displayColumns: [
      { name: "id", label: "ID" },
      { name: "humor_flavor_id", label: "Flavor ID" },
      { name: "order_by", label: "Order" },
      { name: "humor_flavor_step_type_id", label: "Step Type" },
      { name: "llm_model_id", label: "Model ID" },
      { name: "llm_temperature", label: "Temp" },
    ],
    fields: [],
    orderBy: "created_datetime_utc",
  },
  "humor-flavor-mix": {
    ...
    displayColumns: [
      { name: "id", label: "ID" },
      { name: "humor_flavor_id", label: "Flavor ID" },
      { name: "caption_count", label: "Caption Count" },
      { name: "created_datetime_utc", label: "Created" },
    ],
    fields: [
  ...
  terms: {
    ...
    displayColumns: [
      ...
      { name: "priority", label: "Priority" },
      { name: "term_type_id", label: "Type ID" },
      { name: "created_datetime_utc", label: "Created" },
    ],
    fields: [
  ...
  "llm-models": {
    ...
    displayColumns: [
      ...
      { name: "provider_model_id", label: "Model ID" },
      { name: "is_temperature_supported", label: "Temp Support" },
    ],
    fields: [
  ...
  "llm-prompt-chains": {
    ...
    displayColumns: [
      { name: "id", label: "ID" },
      { name: "caption_request_id", label: "Request ID" },
      { name: "created_datetime_utc", label: "Created" },
    ],
    fields: [],
    orderBy: "created_datetime_utc",
  ...
  "llm-model-responses": {
    ...
    displayColumns: [
      ...
      { name: "llm_model_id", label: "Model ID" },
      { name: "humor_flavor_id", label: "Flavor ID" },
      { name: "processing_time_seconds", label: "Time (s)" },
      { name: "llm_temperature", label: "Temp" },
      { name: "created_datetime_utc", label: "Created" },
    ],
    fields: [],
